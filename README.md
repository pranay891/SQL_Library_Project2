...
add constraint fk_member_id foreign key(issued_member_id)
references members(member_id);

Alter table issued_status
add constraint fk_isbn foreign key(issued_book_isbn)
...
add constraint fk_issue_id foreign key(issued_id)
...
VALUES
('B001', 'E109', '123 Main St', '9099988676'),
('B002', 'E109', '456 Elm St', '9099988677'),
('B003', 'E109', '789 Oak St', '9099988678'),
('B004', 'E110', '567 Pine St', '9099988679'),
('B005', 'E110', '890 Maple St', '9099988680');
SELECT * FROM branch;
...
VALUES
('RS101', 'IS121', '2023-06-06'),
('RS102', 'IS122', '2023-06-07'),
('RS103', 'IS123', '2023-08-07'),
...
--OR
select ist.issued_emp_id,e.emp_name,count(*) as total_book_issued from issued_status ist join employees e 
...
create table book_cnt as select b.isbn,b.book_title,count(*) as book_cnt as total_book_cnt from 
books b join issued_status ist
on b.isbn=ist.issued_book_isbn
group by b.isbn,b.book_title;

select * from book_cnt;

--Q7. Retrieve All Books in a Specific Category for classic:
select * from books 
...
--Q9. List Members Who Registered in the Last 100 Days.
select member_name,reg_date from members
where age(current_date,reg_date)<interval '180 days';
--OR
select member_name,reg_date from members
...
INSERT INTO members(member_id, member_name, member_address, reg_date)
VALUES
('C004', 'sam', '145 Main St', '2026-06-01'),
('C005', 'john', '133 Main St', '2026-05-01');

--Q10. List Employees with Their Branch Manager's Name and their branch details.
select e.emp_name,b.manager_id from employees e join branch b on e.branch_id=b.branch_id 
